...
This file was a full, independently-runnable copy of main.py (379 lines, last
...
The original executable content is fully preserved in git history:
    git log --follow -- ARCHIVED_main_backups/main_backup_e84b.py
or the pre-archival commit on `main` (docs/KIRAN_CLEANUP_AUDIT.md §103).
"""

raise RuntimeError(
    "main_backup_e84b.py is archived and neutralized (TR-12, ledger §103). "
