...
This file was a full, independently-runnable copy of main.py (402 lines, last
modified 2026-07-08) sitting in the repo root — one of four such copies
...
The original executable content is fully preserved in git history:
    git log --follow -- ARCHIVED_main_backups/main_backup_e86a.py
or the pre-archival commit on `main` (docs/KIRAN_CLEANUP_AUDIT.md §103).
"""

raise RuntimeError(
    "main_backup_e86a.py is archived and neutralized (TR-12, ledger §103). "
